...
! author Elizabeth C. Hunke, LANL
      ...
      integer (kind=int_kind), parameter, public :: &
         ...
         max_mp     =   6       , & ! maximum number of microplastics
      ...
      logical (kind=log_kind), public :: &
         ...
         tr_mp        = .false., & ! if .true., use microplastics tracers
...
! query the number of column tracers
      ...
      subroutine icepack_query_tracer_sizes(&
         ...
         nmodal2_out    , max_aero_out   , max_mp_out       , &
         max_nbtrcr_out ,                                     &
      ...
      integer (kind=int_kind), intent(out), optional :: &
         ...
         max_mp_out     , & ! maximum number of microplastics
...
!autodocument_end
        ...
        if (present(max_mp_out))     max_mp_out    = max_mp
...
!autodocument_end
        ...
        write(iounit,*) "  max_mp_out    =", max_mp
